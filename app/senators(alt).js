...
blumenthal.imageUrl = function () {
    return `images/${blumenthal.id}-240.png`;
};
...
murphy.imageUrl = function () {
    return `images/${murphy.id}-240.png`;
};
...
collins.imageUrl = function () {
    return `images/${collins.id}-240.png`;
};
...
markey.imageUrl = function () {
    return `images/${markey.id}-240.png`;
};
...
warren.imageUrl = function () {
    return `images/${warren.id}-240.png`;
};
...
hassan.imageUrl = function () {
    return `images/${hassan.id}-240.png`;
};
...
shaheen.imageUrl = function () {
    return `images/${shaheen.id}-240.png`;
};
...
whitehouse.imageUrl = function () {
    return `images/${whitehouse.id}-240.png`;
};
...
leahy.imageUrl = function () {
    return `images/${leahy.id}-240.png`;
};
...
sanders.imageUrl = function () {
    return `images/${sanders.id}-240.png`;
};
